...
import static AI.AIControl.State.Follow;
import static AI.AIControl.State.Idle;
...
public class AIControl extends AbstractControl{
    ...
    private AIControl.State state = AIControl.State.Idle;
    ...
    public AIControl.State getState() {
        return state;
    }

    public void setState(AIControl.State state) {
        this.state = state;
    }
